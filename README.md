...
## General Notes 
 ...
 - There are **two** components:
   - Chrome Extension << Source code [v1.5.2]: `Extension` || Release [v1.5.1]: [<ins>**Chrome Web Store**</ins>](https://chrome.google.com/webstore/detail/youtubediscordpresence/hnmeidgkfcbpjjjpmjmpehjdljlaeaaa) >>
   - Desktop Application << Source code [v1.4.1]: `Host` || Release [v1.4.0]: [**<ins>Releases</ins>**](https://github.com/XFG16/YouTubeDiscordPresence/releases/tag/1.4.0) >>
